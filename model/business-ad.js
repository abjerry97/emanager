...
const BusinessAdSchema = new mongoose.Schema(businessAdSchemaObject);

BusinessAdSchema.statics.getSchemaObject = () => businessAdSchemaObject;
const BusinessAd = mongoose.model("BusinessAd", BusinessAdSchema);

module.exports = BusinessAd;
