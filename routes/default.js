...
const { isAuth, travelMode, refreshUserUpdates } = require("../utils");
...
function defaultRoute(ree) {
  ...
  router
  .route("/property/ads/:propertyAdId")
  .get( (req, res, next) => {
  ...
  router.route("/properties/:propertyId/rate").post(isAuth, (req, res, next) => {
